...
openR :: forall f e. Path -> Eff (filesystem :: Filesystem | e) (Either String (Readable (seek :: Seek) (filesystem :: Filesystem | f)))
openR = unsafeCoerce <<< openImpl Left Right "r"

openRB :: forall f e. Path -> Eff (filesystem :: Filesystem | e) (Either String (Readable (binary :: Binary, seek :: Seek) (filesystem :: Filesystem | f)))
openRB = unsafeCoerce <<< openImpl Left Right "rb"

openW :: forall f e. Path -> Eff (filesystem :: Filesystem | e) (Either String (Writable (seek :: Seek) (filesystem :: Filesystem | f)))
openW = unsafeCoerce <<< openImpl Left Right "w"

openWB :: forall f e. Path -> Eff (filesystem :: Filesystem | e) (Either String (Writable (binary :: Binary, seek :: Seek) (filesystem :: Filesystem | f)))
openWB = unsafeCoerce <<< openImpl Left Right "wb"

openA :: forall f e. Path -> Eff (filesystem :: Filesystem | e) (Either String (Writable (seek :: Seek) (filesystem :: Filesystem | f)))
openA = unsafeCoerce <<< openImpl Left Right "a"

openAB :: forall f e. Path -> Eff (filesystem :: Filesystem | e) (Either String (Writable (binary :: Binary, seek :: Seek) (filesystem :: Filesystem | f)))
